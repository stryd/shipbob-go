...
// checks if the ShipmentProduct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShipmentProduct{}
...
func (o ShipmentProduct) ToMap() (map[string]interface{}, error) {
