...
// checks if the ReturnOrderStatusHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnOrderStatusHistory{}
...
func (o ReturnOrderStatusHistory) ToMap() (map[string]interface{}, error) {
