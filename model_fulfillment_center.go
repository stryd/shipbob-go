...
// checks if the FulfillmentCenter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FulfillmentCenter{}
...
func (o FulfillmentCenter) MarshalJSON() ([]byte, error) {
...
func (o FulfillmentCenter) ToMap() (map[string]interface{}, error) {
...
type NullableFulfillmentCenter struct {
	value *FulfillmentCenter
	isSet bool
}

func (v NullableFulfillmentCenter) Get() *FulfillmentCenter {
	return v.value
}

func (v *NullableFulfillmentCenter) Set(val *FulfillmentCenter) {
	v.value = val
	v.isSet = true
}

func (v NullableFulfillmentCenter) IsSet() bool {
	return v.isSet
}

func (v *NullableFulfillmentCenter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFulfillmentCenter(val *FulfillmentCenter) *NullableFulfillmentCenter {
	return &NullableFulfillmentCenter{value: val, isSet: true}
}

func (v NullableFulfillmentCenter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFulfillmentCenter) UnmarshalJSON(src []byte) error {
	v.isSet = true
