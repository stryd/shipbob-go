...
// OrdersEstimateProductInfoModel struct for OrdersEstimateProductInfoModel
type OrdersEstimateProductInfoModel struct {
...
func NewOrdersEstimateProductInfoModel(quantity int32, ) *OrdersEstimateProductInfoModel {
	this := OrdersEstimateProductInfoModel{}
...
func (o *OrdersEstimateProductInfoModel) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o OrdersEstimateProductInfoModel) MarshalJSON() ([]byte, error) {
...
type NullableOrdersEstimateProductInfoModel struct {
	value *OrdersEstimateProductInfoModel
	isSet bool
}

func (v NullableOrdersEstimateProductInfoModel) Get() *OrdersEstimateProductInfoModel {
	return v.value
}

func (v *NullableOrdersEstimateProductInfoModel) Set(val *OrdersEstimateProductInfoModel) {
	v.value = val
	v.isSet = true
}

func (v NullableOrdersEstimateProductInfoModel) IsSet() bool {
	return v.isSet
}

func (v *NullableOrdersEstimateProductInfoModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrdersEstimateProductInfoModel(val *OrdersEstimateProductInfoModel) *NullableOrdersEstimateProductInfoModel {
	return &NullableOrdersEstimateProductInfoModel{value: val, isSet: true}
}

func (v NullableOrdersEstimateProductInfoModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrdersEstimateProductInfoModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
