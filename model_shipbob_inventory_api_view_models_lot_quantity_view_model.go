...
// ShipbobInventoryApiViewModelsLotQuantityViewModel Break down of fulfillable quantity by lot
type ShipbobInventoryApiViewModelsLotQuantityViewModel struct {
...
func NewShipbobInventoryApiViewModelsLotQuantityViewModel() *ShipbobInventoryApiViewModelsLotQuantityViewModel {
	this := ShipbobInventoryApiViewModelsLotQuantityViewModel{}
	return &this
}
...
func (o *ShipbobInventoryApiViewModelsLotQuantityViewModel) SetExpirationDateNil() {
...
func (o ShipbobInventoryApiViewModelsLotQuantityViewModel) MarshalJSON() ([]byte, error) {
...
type NullableShipbobInventoryApiViewModelsLotQuantityViewModel struct {
	value *ShipbobInventoryApiViewModelsLotQuantityViewModel
	isSet bool
}

func (v NullableShipbobInventoryApiViewModelsLotQuantityViewModel) Get() *ShipbobInventoryApiViewModelsLotQuantityViewModel {
	return v.value
}

func (v *NullableShipbobInventoryApiViewModelsLotQuantityViewModel) Set(val *ShipbobInventoryApiViewModelsLotQuantityViewModel) {
	v.value = val
	v.isSet = true
}

func (v NullableShipbobInventoryApiViewModelsLotQuantityViewModel) IsSet() bool {
	return v.isSet
}

func (v *NullableShipbobInventoryApiViewModelsLotQuantityViewModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipbobInventoryApiViewModelsLotQuantityViewModel(val *ShipbobInventoryApiViewModelsLotQuantityViewModel) *NullableShipbobInventoryApiViewModelsLotQuantityViewModel {
	return &NullableShipbobInventoryApiViewModelsLotQuantityViewModel{value: val, isSet: true}
}

func (v NullableShipbobInventoryApiViewModelsLotQuantityViewModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipbobInventoryApiViewModelsLotQuantityViewModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
