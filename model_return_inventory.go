...
// checks if the ReturnInventory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnInventory{}
...
func (o ReturnInventory) ToMap() (map[string]interface{}, error) {
