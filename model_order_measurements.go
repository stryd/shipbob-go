...
// checks if the OrderMeasurements type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderMeasurements{}
...
func (o OrderMeasurements) ToMap() (map[string]interface{}, error) {
