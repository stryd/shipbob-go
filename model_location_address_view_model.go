...
// LocationAddressViewModel The service-specific address of the location. Each object contains address type, address1, address2, city, state, country, zip code, phone number, and email
type LocationAddressViewModel struct {
...
func (o *LocationAddressViewModel) SetAddress1Nil() {
	o.Address1.Set(nil)
}
...
func (o *LocationAddressViewModel) SetAddress2Nil() {
	o.Address2.Set(nil)
}
...
func (o *LocationAddressViewModel) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *LocationAddressViewModel) SetCountryNil() {
	o.Country.Set(nil)
}
...
func (o *LocationAddressViewModel) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *LocationAddressViewModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *LocationAddressViewModel) SetPhoneNumberNil() {
...
func (o *LocationAddressViewModel) SetStateNil() {
	o.State.Set(nil)
}
...
func (o *LocationAddressViewModel) SetZipCodeNil() {
	o.ZipCode.Set(nil)
}
...
func (o LocationAddressViewModel) MarshalJSON() ([]byte, error) {
...
type NullableLocationAddressViewModel struct {
	value *LocationAddressViewModel
	isSet bool
}

func (v NullableLocationAddressViewModel) Get() *LocationAddressViewModel {
	return v.value
}

func (v *NullableLocationAddressViewModel) Set(val *LocationAddressViewModel) {
	v.value = val
	v.isSet = true
}

func (v NullableLocationAddressViewModel) IsSet() bool {
	return v.isSet
}

func (v *NullableLocationAddressViewModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocationAddressViewModel(val *LocationAddressViewModel) *NullableLocationAddressViewModel {
	return &NullableLocationAddressViewModel{value: val, isSet: true}
}

func (v NullableLocationAddressViewModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocationAddressViewModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
