...
// ShipbobProductsApiViewModelsPublicProductViewModel struct for ShipbobProductsApiViewModelsPublicProductViewModel
type ShipbobProductsApiViewModelsPublicProductViewModel struct {
	// Barcode for the product
	Barcode NullableString `json:"barcode,omitempty"`
	BundleRootInformation *ShipbobProductsApiViewModelsPublicBundleRootInformationViewModel `json:"bundle_root_information,omitempty"`
	Channel *ShipbobProductsApiViewModelsPublicChannelViewModel `json:"channel,omitempty"`
	// Date the product was created
	CreatedDate *time.Time `json:"created_date,omitempty"`
	// The inventory that this product will resolve to when packing a shipment
	FulfillableInventoryItems []ShipbobProductsApiViewModelsPublicInventoryItemViewModel `json:"fulfillable_inventory_items,omitempty"`
	// Fulfillable quantity of this product broken down by fulfillment center location
	FulfillableQuantityByFulfillmentCenter []ShipbobProductsApiViewModelsPublicFulfillmentCenterQuantityViewModel `json:"fulfillable_quantity_by_fulfillment_center,omitempty"`
...
func NewShipbobProductsApiViewModelsPublicProductViewModel() *ShipbobProductsApiViewModelsPublicProductViewModel {
	this := ShipbobProductsApiViewModelsPublicProductViewModel{}
	return &this
}
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) SetBarcodeNil() {
	o.Barcode.Set(nil)
}
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) GetBundleRootInformation() ShipbobProductsApiViewModelsPublicBundleRootInformationViewModel {
	if o == nil || o.BundleRootInformation == nil {
		var ret ShipbobProductsApiViewModelsPublicBundleRootInformationViewModel
		return ret
	}
...
// SetBundleRootInformation gets a reference to the given ShipbobProductsApiViewModelsPublicBundleRootInformationViewModel and assigns it to the BundleRootInformation field.
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) GetChannel() ShipbobProductsApiViewModelsPublicChannelViewModel {
	if o == nil || o.Channel == nil {
		var ret ShipbobProductsApiViewModelsPublicChannelViewModel
		return ret
	}
	return *o.Channel
}
...
// SetChannel gets a reference to the given ShipbobProductsApiViewModelsPublicChannelViewModel and assigns it to the Channel field.
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) GetFulfillableInventoryItems() []ShipbobProductsApiViewModelsPublicInventoryItemViewModel {
	if o == nil  {
		var ret []ShipbobProductsApiViewModelsPublicInventoryItemViewModel
		return ret
	}
...
// SetFulfillableInventoryItems gets a reference to the given []ShipbobProductsApiViewModelsPublicInventoryItemViewModel and assigns it to the FulfillableInventoryItems field.
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) GetFulfillableQuantityByFulfillmentCenter() []ShipbobProductsApiViewModelsPublicFulfillmentCenterQuantityViewModel {
	if o == nil  {
		var ret []ShipbobProductsApiViewModelsPublicFulfillmentCenterQuantityViewModel
		return ret
	}
...
// SetFulfillableQuantityByFulfillmentCenter gets a reference to the given []ShipbobProductsApiViewModelsPublicFulfillmentCenterQuantityViewModel and assigns it to the FulfillableQuantityByFulfillmentCenter field.
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) SetReferenceIdNil() {
...
func (o *ShipbobProductsApiViewModelsPublicProductViewModel) SetSkuNil() {
	o.Sku.Set(nil)
}
...
func (o ShipbobProductsApiViewModelsPublicProductViewModel) MarshalJSON() ([]byte, error) {
...
type NullableShipbobProductsApiViewModelsPublicProductViewModel struct {
	value *ShipbobProductsApiViewModelsPublicProductViewModel
	isSet bool
}

func (v NullableShipbobProductsApiViewModelsPublicProductViewModel) Get() *ShipbobProductsApiViewModelsPublicProductViewModel {
	return v.value
}

func (v *NullableShipbobProductsApiViewModelsPublicProductViewModel) Set(val *ShipbobProductsApiViewModelsPublicProductViewModel) {
	v.value = val
	v.isSet = true
}

func (v NullableShipbobProductsApiViewModelsPublicProductViewModel) IsSet() bool {
	return v.isSet
}

func (v *NullableShipbobProductsApiViewModelsPublicProductViewModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipbobProductsApiViewModelsPublicProductViewModel(val *ShipbobProductsApiViewModelsPublicProductViewModel) *NullableShipbobProductsApiViewModelsPublicProductViewModel {
	return &NullableShipbobProductsApiViewModelsPublicProductViewModel{value: val, isSet: true}
}

func (v NullableShipbobProductsApiViewModelsPublicProductViewModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipbobProductsApiViewModelsPublicProductViewModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
