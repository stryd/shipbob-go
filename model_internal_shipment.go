...
// checks if the InternalShipment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalShipment{}

// InternalShipment struct for InternalShipment
type InternalShipment struct {
...
// GetIsTrackingUploaded returns the IsTrackingUploaded field value if set, zero value otherwise.
func (o *InternalShipment) GetIsTrackingUploaded() bool {
	if o == nil || IsNil(o.IsTrackingUploaded) {
		var ret bool
		return ret
	}
	return *o.IsTrackingUploaded
}

// GetIsTrackingUploadedOk returns a tuple with the IsTrackingUploaded field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalShipment) GetIsTrackingUploadedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsTrackingUploaded) {
		return nil, false
	}
	return o.IsTrackingUploaded, true
}
...
// SetIsTrackingUploaded gets a reference to the given bool and assigns it to the IsTrackingUploaded field.
func (o *InternalShipment) SetIsTrackingUploaded(v bool) {
	o.IsTrackingUploaded = &v
}

// GetLastTrackingUpdateAt returns the LastTrackingUpdateAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *InternalShipment) GetLastTrackingUpdateAt() time.Time {
	if o == nil || IsNil(o.LastTrackingUpdateAt.Get()) {
		var ret time.Time
		return ret
	}
	return *o.LastTrackingUpdateAt.Get()
}

// GetLastTrackingUpdateAtOk returns a tuple with the LastTrackingUpdateAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetLastTrackingUpdateAt gets a reference to the given NullableTime and assigns it to the LastTrackingUpdateAt field.
...
// GetParentCartons returns the ParentCartons field value if set, zero value otherwise.
func (o *InternalShipment) GetParentCartons() []ParentCarton {
	if o == nil || IsNil(o.ParentCartons) {
		var ret []ParentCarton
		return ret
	}
	return o.ParentCartons
}

// GetParentCartonsOk returns a tuple with the ParentCartons field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalShipment) GetParentCartonsOk() ([]ParentCarton, bool) {
	if o == nil || IsNil(o.ParentCartons) {
		return nil, false
	}
	return o.ParentCartons, true
}
...
// SetParentCartons gets a reference to the given []ParentCarton and assigns it to the ParentCartons field.
...
// GetStoreOrderId returns the StoreOrderId field value if set, zero value otherwise.
func (o *InternalShipment) GetStoreOrderId() string {
	if o == nil || IsNil(o.StoreOrderId) {
		var ret string
		return ret
	}
	return *o.StoreOrderId
}
...
// SetStoreOrderId gets a reference to the given string and assigns it to the StoreOrderId field.
...
func (o InternalShipment) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsTrackingUploaded) {
		toSerialize["is_tracking_uploaded"] = o.IsTrackingUploaded
	}
	if o.LastTrackingUpdateAt.IsSet() {
		toSerialize["last_tracking_update_at"] = o.LastTrackingUpdateAt.Get()
	}
	...
	if !IsNil(o.ParentCartons) {
		toSerialize["parent_cartons"] = o.ParentCartons
	}
	if !IsNil(o.Products) {
	...
	if !IsNil(o.StoreOrderId) {
		toSerialize["store_order_id"] = o.StoreOrderId
	}
	if !IsNil(o.Tracking) {
...
type NullableInternalShipment struct {
	value *InternalShipment
	isSet bool
}

func (v NullableInternalShipment) Get() *InternalShipment {
	return v.value
}

func (v *NullableInternalShipment) Set(val *InternalShipment) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalShipment) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalShipment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalShipment(val *InternalShipment) *NullableInternalShipment {
	return &NullableInternalShipment{value: val, isSet: true}
}

func (v NullableInternalShipment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalShipment) UnmarshalJSON(src []byte) error {
	v.isSet = true
