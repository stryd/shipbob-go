...
// SetBoxItems gets a reference to the given []BoxItem and assigns it to the BoxItems field.
...
// SetBoxStatus gets a reference to the given BoxStatus and assigns it to the BoxStatus field.
