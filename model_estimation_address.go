...
// checks if the EstimationAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EstimationAddress{}
...
func (o EstimationAddress) ToMap() (map[string]interface{}, error) {
