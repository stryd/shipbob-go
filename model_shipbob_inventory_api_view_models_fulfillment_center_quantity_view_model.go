...
// ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel Break down of fulfillable quantity by fulfillment center
type ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel struct {
...
func NewShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel() *ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel {
	this := ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel{}
	return &this
}
...
func (o ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) MarshalJSON() ([]byte, error) {
...
type NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel struct {
	value *ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel
	isSet bool
}

func (v NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) Get() *ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel {
	return v.value
}

func (v *NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) Set(val *ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) {
	v.value = val
	v.isSet = true
}

func (v NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) IsSet() bool {
	return v.isSet
}

func (v *NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel(val *ShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) *NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel {
	return &NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel{value: val, isSet: true}
}

func (v NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShipbobInventoryApiViewModelsFulfillmentCenterQuantityViewModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
