...
// InventoryLotQuantityViewModel Break down of fulfillable quantity by lot
type InventoryLotQuantityViewModel struct {
...
func NewInventoryLotQuantityViewModel() *InventoryLotQuantityViewModel {
	this := InventoryLotQuantityViewModel{}
	return &this
}
...
func (o *InventoryLotQuantityViewModel) SetExpirationDateNil() {
...
func (o InventoryLotQuantityViewModel) MarshalJSON() ([]byte, error) {
...
type NullableInventoryLotQuantityViewModel struct {
	value *InventoryLotQuantityViewModel
	isSet bool
}

func (v NullableInventoryLotQuantityViewModel) Get() *InventoryLotQuantityViewModel {
	return v.value
}

func (v *NullableInventoryLotQuantityViewModel) Set(val *InventoryLotQuantityViewModel) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryLotQuantityViewModel) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryLotQuantityViewModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryLotQuantityViewModel(val *InventoryLotQuantityViewModel) *NullableInventoryLotQuantityViewModel {
	return &NullableInventoryLotQuantityViewModel{value: val, isSet: true}
}

func (v NullableInventoryLotQuantityViewModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryLotQuantityViewModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
